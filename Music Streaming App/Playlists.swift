            ...
            Rectangle()
              ...
              .background(
                Image("Logo")
                  ...
                  .clipped()
                  .cornerRadius(200)
                  .frame(width: 159, height: 630, alignment: .top)
              )
            */
            ...
            Image("Search-Icon")
              ...
              .frame(width: 130, height: 590, alignment: .topLeading)
            
            Text("Search Playlist")
                .font(Font.custom("Inter", size: 12))
                .multilineTextAlignment(.trailing)
                .foregroundColor(Color(red: 0.59, green: 0.55, blue: 0.55))
                .frame(width: 85, height: 1280, alignment: .topLeading)
            ...
            Image("Current-Bar")
              ...
              .frame(width: 225, height: 635, alignment: .bottomLeading))
            ...
            Rectangle()
              ...
              .background(Color(red: 0.98, green: 0.82, blue: 0.58))
              .frame(width: 348, height: 758, alignment: .bottomLeading)
